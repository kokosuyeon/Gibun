    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            ...
            <div class="col-sm-9">
            	...
            	<hr>
                <div class="row">
		            <form action="/goodM/diaryBoard/update" method="post" enctype="multipart/form-data">
		            	<input type="hidden" name="did" value="${diaryBoard.did}">  <!-- did 색깔 다름.. 확인필요 -==== -->
		            	<input type="hidden" name="uid" value="${diaryBoard.uid}">
		                <table class="table table-borderless">
		                    <tr class="d-flex">
		                        <td class="col-1"><label for="title">제목</label></td>
		                        <td class="col-11" colspan="2"><input class="form-control" type="text" name="title" id="title" value="${diaryBoard.title}"></td>
		                    </tr>
		                    <tr class="d-flex">
		                        <td class="col-1"><label for="content">내용</label></td>
		                        <td class="col-11" colspan="2">
		                        	<textarea class="form-control" name="content" id="content" rows="10">${diaryBoard.content}</textarea>
		                        </td>
		                    </tr>
		                    <tr class="d-flex">
